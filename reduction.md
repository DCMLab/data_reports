...
non_modulatory_phrases = phrases_with_unique_key[phrases_with_unique_key.local_keys.notna()]
...
mask = make_boolean_mask_from_set_of_tuples(phrase_segments.index, set(major_phrases.index))
